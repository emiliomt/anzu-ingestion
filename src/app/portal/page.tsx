...
import { Globe, Mail, MessageCircle, Shield, Zap, Search, ArrowLeft } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-purple-50">
      ...
      <header className="border-b border-white/60 backdrop-blur bg-white/70 sticky top-0 z-10">
        <div className="max-w-6xl mx-auto px-4 h-16 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <Link href="/" className="flex items-center gap-2 text-gray-500 hover:text-gray-700 text-sm mr-2">
              <ArrowLeft className="w-4 h-4" />
            </Link>
            <div className="w-9 h-9 bg-orange-500 rounded-xl flex items-center justify-center">
              <span className="text-white font-bold text-sm">AZ</span>
            </div>
            <span className="font-semibold text-gray-900 text-lg">Anzu Dynamics</span>
          </div>
          <div className="flex items-center gap-3">
      ...
      <section className="max-w-6xl mx-auto px-4 pt-16 pb-12 text-center">
        <div className="inline-flex items-center gap-2 px-3 py-1 bg-orange-50 rounded-full text-orange-700 text-xs font-medium mb-6">
      ...
      <section className="max-w-2xl mx-auto px-4 pb-16">
        ...
        <div className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div className="card p-4">
            ...
            <code className="block mt-1 text-xs font-mono bg-gray-50 px-2 py-1 rounded border text-orange-600">
              invoices@anzuapp.io
            </code>
          </div>
          <div className="card p-4">
