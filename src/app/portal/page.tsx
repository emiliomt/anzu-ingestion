    ...
    <>
      ...
      {mobileOpen && (
        <div className="fixed inset-0 z-50 md:hidden flex">
          ...
          />
          <div
            className="relative flex flex-col w-[85vw] max-w-sm h-full bg-white anzu-drawer-open"
          ...
          >
            ...
            <div
              className="shrink-0 px-4 pt-4 border-t border-gray-100"
  ...
  return (
    <div className="min-h-screen" style={{ background: "#F8FAFC" }}>
      ...
      <section
        ...
        style={{
          background: "linear-gradient(135deg, #0C1B3A 0%, #1E293B 60%, #0C1B3A 100%)",
          padding: "72px 0 48px",
        }}
      >
        ...
        <div className="relative max-w-2xl mx-auto px-4 sm:px-6 text-center">
          ...
          <p
            className="text-gray-300 mb-10 anzu-fade-up"
          ...
          <div className="flex items-center justify-center gap-3 flex-wrap anzu-fade-up" style={{ animationDelay: "280ms" }}>
            {[
      ...
      <section className="max-w-5xl mx-auto px-4 sm:px-6 mt-8 pb-16">
            ...
            {[
              {
                ...
                desc: "Send your PDF or image invoice to:",
                code: "invoices@anzu.mx",
              },
              {
                icon: MessageCircle,
                color: "#10B981",
                bg: "#ECFDF5",
                title: "WhatsApp",
                desc: "Send your invoice image or PDF to:",
                code: "+1 (415) 523-8886",
              },
            ].map((ch) => {
              const Icon = ch.icon;
              return (
                ...
                >
                  ...
                  <code
                    className="block text-xs px-2.5 py-1.5 rounded-lg border font-mono"
                    style={{ background: "#F8FAFC", borderColor: "#E2E8F0", color: "#0C1B3A" }}
                  >
                    {ch.code}
                  </code>
                </div>
        ...
        >
          ...
          <p className="text-xs text-gray-500 mb-4">
            Enter your reference number or UUID to see real-time status.
          </p>
          <StatusTracker />
        </div>
      </section>
      ...
      <footer className="border-t border-gray-100 bg-white py-6">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 flex flex-col sm:flex-row items-center justify-between gap-3">
          ...
          <p className="text-xs text-gray-400 text-center">
            © 2025 Anzu Dynamics · Accounts Payable Automation Platform
          </p>
