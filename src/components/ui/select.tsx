// Anzu Dynamics — Select component (shadcn/ui pattern)
// Used for ERP type selectors, currency selectors, status filters.
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      "flex h-9 w-full items-center justify-between whitespace-nowrap rounded-lg border border-gray-200 bg-white px-3 py-2 text-sm shadow-sm ring-offset-white",
